...
mysql -e "use zabbix;truncate table history;optimize table history;"
mysql -e "use zabbix;truncate table history_uint;optimize table history_uint;"
mysql -e "use zabbix;truncate table trends;optimize table trends;"
mysql -e "use zabbix;truncate table trends_uint;optimize table trends_uint;"
